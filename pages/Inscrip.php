      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="Index.php">Liste des Compte</a>
        ...
        <div class="container-fluid">
         ...
         <div class="col-lg-7">
            <div class="p-5">
              ...
              <form Method="POST" Action="../api/inscri.php" >
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" id="Matricule" name='Matricule'  placeholder="Matricule">
                  </div>
                  <div class="col-sm-6">
                    <input type="number" style='text-align:center;' class="form-control form-control-user" min="1" max="3" name='Niveau' id="Niveau" placeholder="Niveau d'authentification">
                  </div>
                </div>
